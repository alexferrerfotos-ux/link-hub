...
const Tracking = (() => {
    // Configurações
    const CONFIG = {
        API_ENDPOINT: 'COLOQUE_AQUI_A_URL_DO_SEU_GOOGLE_APPS_SCRIPT',
        // Exemplo: https://script.google.com/macros/s/AKfycbx.../usercopy
        DEBOUNCE_TIME: 1000, // 1 segundo
        DEBUG: true // Ativar logs no console para debug
    };
